...
进入 **助手** 对话页，在助手列表中点击添加入口，然后选择浏览助手库。这里可以浏览预设、创建助手，以及管理已有助手。

<figure><img src="../../.gitbook/assets/cherry-assistants-v2.png" alt=""><figcaption><p>V2 助手对话页：左侧直接管理助手和对话</p></figcaption></figure>
...
* 点击助手卡片 ➡️ 选择 `添加到助手`
* 之后在对话页助手列表中即可看到该助手
* 已添加的助手会进入助手列表，可继续编辑或分组

### 创建自己的助手

1. 在助手页打开添加菜单，点击 `创建助手`
2. 按向导完成三个步骤：
