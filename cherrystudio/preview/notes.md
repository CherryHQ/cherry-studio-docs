...
<figure><img src="../../.gitbook/assets/cherry-notes-v2.png" alt="Cherry Studio V2 笔记页面"><figcaption><p>V2 笔记空页面：左侧为目录区域，右侧为编辑区。</p></figcaption></figure>
...
* **导出 ›** 二级菜单：Markdown / Word（.docx）/ Notion / 语雀 / Obsidian / Joplin / 思源，以及“复制为图片 / 导出为图片”——相关导出项在 `设置 → 数据 → 导出菜单设置` 中管理
* **删除**
...
笔记内容存储为本地文件。应用数据目录在 `设置 → 数据 → 数据目录` 中查看；笔记页自身的更多设置用于调整编辑器显示。
