...
> **Data Update Time**: 2025-09-26 11:35:35 UTC / 2025-09-26 19:35:35 CST (Beijing Time)
...
- **Model Name**: The name of the Large Language Model (LLM). This column includes links to model-related information; clicking will redirect you.
...
- **Knowledge Cutoff Date**: The knowledge cutoff date of the model's training data. **No data** indicates that the relevant information is not provided or is unknown.

## Data Source and Update Frequency

This leaderboard's data is automatically generated and provided by the [fboulnois/llm-leaderboard-csv](https://github.com/fboulnois/llm-leaderboard-csv) project, which obtains and processes data from [lmarena.ai](https://lmarena.ai/). This leaderboard is updated daily via GitHub Actions.

## Disclaimer

This report is for reference only. Leaderboard data is dynamic and based on user preference votes on Chatbot Arena over a specific period. The completeness and accuracy of the data depend on the upstream data source and the `fboulnois/llm-leaderboard-csv` project's updates and processing. Different models may have different license agreements; please refer to the official documentation provided by the model vendors for usage.