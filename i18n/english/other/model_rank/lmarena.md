...
This is a leaderboard generated through an automated process, based on data from Chatbot Arena (lmarena.ai).

> **Data Update Time**: 2025-08-29 11:40:45 UTC / 2025-08-29 19:40:45 CST (Beijing Time)
...
| 121 | 114 | [Yi-Large-preview](https://platform.lingyiwanwu.com/docs#%E6%A8%A1%E5%9E%8B) | 1258 | +4/-4 | 51,628 | 01 AI | Proprietary | No data |
...
| 132 | 126 | [Yi-Large](https://platform.01.ai/docs#models-and-pricing) | 1235 | +6/-6 | 16,624 | 01 AI | Proprietary | No data |
...
| 140 | 127 | [GLM-4-0520](https://open.bigmodel.cn/dev/api#language) | 1230 | +6/-6 | 10,221 | Zhipu AI | Proprietary | No data |
...
| 161 | 154 | [GLM-4-0116](https://open.bigmodel.cn/) | 1198 | +9/-9 | 7,579 | Zhipu AI | Proprietary | No data |
...
*   **Rank (UB)**: Rank calculated based on the Bradley-Terry model. This rank reflects the overall performance of models in the arena and provides an **upper bound** estimate of their Elo scores, helping to understand the model's potential competitiveness.
*   **Rank (StyleCtrl)**: Rank after controlling for conversation style. This ranking aims to reduce preference bias caused by model response styles (e.g., verbose, concise), providing a purer evaluation of the model's core capabilities.
*   **Model Name**: Name of the Large Language Model (LLM). This column embeds links to model-related pages; click to jump.
*   **Score**: The Elo score obtained by the model through user votes in the arena. Elo score is a relative ranking system, where a higher score indicates better model performance. This score is dynamic and reflects the model's relative strength in the current competitive environment.
*   **Confidence Interval**: The 95% confidence interval for the model's Elo score (e.g., `+6/-6`). A smaller interval indicates a more stable and reliable score; conversely, a larger interval may suggest insufficient data or greater volatility in model performance. It provides a quantitative assessment of score accuracy.
...
*   **License**: Type of license agreement for the model, such as Proprietary, Apache 2.0, MIT, etc.
*   **Knowledge Cutoff Date**: Knowledge cutoff date for the model's training data. **No data** indicates that the relevant information is not provided or is unknown.
