...
> **Data last updated**: 2025-08-14 11:43:45 UTC / 2025-08-14 19:43:45 CST (Beijing Time)
...
- **Rank (StyleCtrl)**: Rank after controlling for conversation style. This rank aims to reduce preference bias caused by model response styles (e.g., verbose, concise) to more purely evaluate the model's core capabilities.
- **Model Name**: The name of the Large Language Model (LLM). This column includes links related to the model; click to navigate.
