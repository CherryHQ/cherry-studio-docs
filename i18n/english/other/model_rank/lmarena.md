...
> **Data Update Time**: 2025-09-24 11:35:50 UTC / 2025-09-24 19:35:50 CST (Beijing Time)
...
| Rank (UB) | Rank (StyleCtrl) | Model Name | Score | Confidence Interval | Votes | Vendor | License Agreement | Knowledge Cutoff Date |
|:---|:---|:---|:---|:---|:---|:---|:---|:---|
...
-   **Rank (StyleCtrl)**: Ranking after controlling for conversation style. This ranking aims to reduce preference bias caused by model response styles (e.g., verbose, concise), providing a purer evaluation of the model's core capabilities.
-   **Model Name**: The name of the Large Language Model (LLM). This column embeds links related to the models, which can be clicked to jump to them.
...
-   **Vendor**: The organization or company that provides the model.
