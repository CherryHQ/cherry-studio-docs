...
* [Feature Overview](cherrystudio/preview/README.md)
  ...
  * [Quick Assistants](cherrystudio/preview/kuai-jie-zhu-shou.md)
  * [Settings](cherrystudio/preview/settings/README.md)
    ...
    * [Keyboard Shortcuts](cherrystudio/preview/settings/key-shortcut.md)
...
* [Model Service Configuration](pre-basic/providers/README.md)
  ...
  * [OneAPI and Fork Projects](pre-basic/providers/oneapi/README.md)
...
* [Web-enabled Mode](websearch/README.md)
  * [Free Web-enabled Mode](websearch/mian-fei-lian-wang-mo-shi.md)
  * [Web Search Blacklist Configuration](websearch/blacklist.md)
  * [Volc Engine Integration](websearch/volcengine.md)
  * [Tavily Setup Guide](websearch/tavily.md)
  * [SearXNG Local Deployment](websearch/searxng.md)
* [Data Settings](data-settings/README.md)
  * [Notion Configuration](data-settings/notion.md)
  * [Obsidian Configuration](data-settings/obsidian.md)
  * [SiYuan Notes Configuration](data-settings/siyuan.md)
* [Personalization Settings](personalization-settings/README.md)
  ...
  * [Modify Storage Location](personalization-settings/storage.md)
...
* [MCP Usage Guide](advanced-basic/mcp/README.md)
  * [MCP Environment Setup](advanced-basic/mcp/install.md)
  * [Configuring and Using MCP](advanced-basic/mcp/config.md)
  ...
  * [Adding ModelScope MCP Server](advanced-basic/mcp/tian-jia-modelscope-mcp-fu-wu-qi.md)
  * [FAQs](advanced-basic/mcp/chang-jian-wen-ti.md)
...
* [Documentation Contributions](contribution/docs.md)
