...
* [Описание функций](cherrystudio/preview/README.md)
  ...
  * [Настройки](cherrystudio/preview/settings/README.md)
    ...
    * [Локальные модели](cherrystudio/preview/settings/local-models.md)
    * [Основные настройки](cherrystudio/preview/settings/general.md)
    * [Настройки внешнего вида](cherrystudio/preview/settings/display.md)
...
* [Настройки данных](data-settings/README.md)
  ...
  * [Настройка и экспорт Notion](data-settings/notion.md)
  * [Интеграция с Obsidian](data-settings/obsidian.md)
  * [Настройка и экспорт в SiYuan](data-settings/siyuan.md)
...
* [API Сервер](advanced-basic/api-server.md)
