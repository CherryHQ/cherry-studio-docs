...
* [Планирование проекта](cherrystudio/planning.md)
...
## Основные руководства <a href="#pre-basic" id="pre-basic"></a>

* [Руководства по установке](pre-basic/installation/README.md)
...
* [Настройка сервисов моделей](pre-basic/providers/README.md)
  * [Бесплатные модели](pre-basic/providers/cherryin/README.md)
  ...
  * [Вулканический движок](pre-basic/providers/doubao.md)
  * [Облако Huawei](pre-basic/providers/huawei.md)
  * [Беспрекословное сердце и небо](pre-basic/providers/wu-wen-xin-qiong.md)
  * [Пользовательские провайдеры](pre-basic/providers/zi-ding-yi-fu-wu-shang.md)
  * [CherryIN](pre-basic/providers/cherryin-1.md)

***

* [Режим с подключением к сети](websearch/README.md)
  * [Бесплатный режим с подключением к сети](websearch/mian-fei-lian-wang-mo-shi.md)
  * [Настройка черного списка поиска в сети](websearch/blacklist.md)
  * [Подключение вулканического движка к сети](websearch/volcengine.md)
  * [Руководство по регистрации и входу в Tavily](websearch/tavily.md)
  * [Локальное развертывание и настройка SearXNG](websearch/searxng.md)
* [Настройки данных](data-settings/README.md)
  * [Резервное копирование через WebDAV](data-settings/WebDAV.md)
  * [Резервное копирование на S3-совместимое хранилище](data-settings/s3-compatible.md)
...
* [Персонализация](personalization-settings/README.md)
  ...
  * [Очистка настроек CSS](personalization-settings/clear-css.md)

## Руководства по базе знаний <a href="#knowledge-base" id="knowledge-base"></a>

* [Руководства по базе знаний](knowledge-base/knowledge-base.md)
* [Данные базы знаний](knowledge-base/data.md)
* [Справочная информация по встраиваемым моделям](knowledge-base/emb-models-info.md)
...
* [Руководство по использованию MCP](advanced-basic/mcp/README.md)
  ...
  * [Встроенная настройка MCP](advanced-basic/mcp/in-memory.md)
...
* [Руководство по использованию Cherry Agent](advanced-basic/cherry-agent-shi-yong-jiao-cheng.md)
...
## Вопросы и отзывы <a href="#question-contact" id="question-contact"></a>

* [Часто задаваемые вопросы](question-contact/questions.md)
* [Как эффективно задавать вопросы](question-contact/ask.md)
* [Образовательные материалы](question-contact/knowledge.md)
...
* [Коммерческое сотрудничество](contact-us/questions.md)
  * [Коммерческое соглашение Cherry Studio](contact-us/questions/cherrystudio-xu-ke-xie-yi.md)

## О проекте <a href="#about" id="about"></a>

* [Политика конфиденциальности](about/privacypolicy.md)

## Другое содержимое <a href="#other" id="other"></a>

* [Информация о моделях](other/models-info.md)
