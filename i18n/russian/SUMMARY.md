...
* [Обзор функций](cherrystudio/preview/README.md)
  ...
  * [Настройки](cherrystudio/preview/settings/README.md)
    * [Настройка сервисов моделей](cherrystudio/preview/settings/providers.md)
    ...
    * [Настройка сочетаний клавиш](cherrystudio/preview/settings/key-shortcut.md)
    * [Настройки данных](cherrystudio/preview/settings/data.md)
    * [Функции голоса](cherrystudio/preview/settings/yu-yin-gong-neng.md)

## Основы <a href="#pre-basic" id="pre-basic"></a>
...
* [Настройка сервисов моделей](pre-basic/providers/README.md)
  ...
  * [Qwen](pre-basic/providers/wu-wen-xin-qiong.md)
...
* [Режим онлайн-поиска](websearch/README.md)
  ...
  * [Регистрация и вход в Tavily для онлайн-поиска](websearch/tavily.md)
...
* [Справочная информация по embedding-моделям](knowledge-base/emb-models-info.md)
* [Предварительная обработка документов базы знаний](knowledge-base/zhi-shi-ku-wen-dang-yu-chu-li.md)

## Продвинутые возможности <a href="#advanced-basic" id="advanced-basic"></a>
...
* [Как задать эффективный вопрос](question-contact/ask.md)
