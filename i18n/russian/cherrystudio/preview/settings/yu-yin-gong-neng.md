...
3) Настройте фильтрацию TTS (опционально):
   - Фильтровать процесс мышления
   - Фильтровать разметку Markdown
   - Фильтровать блоки кода
4) Установите, показывать ли индикатор прогресса TTS
5) Нажмите кнопку "Проверить TTS" для тестирования настроек
...
3) Нажмите кнопку "Проверить ASR" для тестирования настроек
...
1) В интерфейсе чата нажмите кнопку голосового звонка (иконка телефона) справа от поля ввода
2) Откроется окно голосового звонка с приветственным сообщением
3) Удерживайте кнопку "Удерживайте для разговора" для начала записи (или используйте назначенную горячую клавишу)
4) Отпустите кнопку для завершения записи и отправки ИИ
5) ИИ сгенерирует ответ и воспроизведёт его через TTS
6) Используйте элементы управления в окне:
...
7) Нажмите кнопку закрытия для завершения звонка

4. Настройка горячих клавиш

1) В окне голосового звонка нажмите кнопку настроек
2) В панели настроек нажмите кнопку горячих клавиш
3) Нажмите клавишу, которую хотите назначить (например, пробел, Shift и т.д.)
4) Нажмите "Сохранить" для применения настроек
5) Используйте: удерживайте назначенную клавишу для начала записи, отпустите для завершения записи и отправки
...
3. Оптимизация голосовых звонков:
