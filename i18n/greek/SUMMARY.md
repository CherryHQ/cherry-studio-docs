...
* [Εισαγωγή λειτουργιών](cherrystudio/preview/README.md)
  ...
  * [Ρυθμίσεις](cherrystudio/preview/settings/README.md)
    * [Ρυθμίσεις υπηρεσίας μοντέλου](cherrystudio/preview/settings/providers.md)
    * [Προεπιλεγμένες ρυθμίσεις μοντέλου](cherrystudio/preview/settings/default-models.md)
    * [Γενικές ρυθμίσεις](cherrystudio/preview/settings/general.md)
    * [Ρυθμίσεις εμφάνισης](cherrystudio/preview/settings/display.md)
    * [Συντομεύσεις πληκτρολογίου](cherrystudio/preview/settings/key-shortcut.md)
    * [Ρυθμίσεις δεδομένων](cherrystudio/preview/settings/data.md)
    * [Φωνητικές λειτουργίες](cherrystudio/preview/settings/yu-yin-gong-neng.md)
...
* [Διαμόρφωση υπηρεσίας μοντέλου](pre-basic/providers/README.md)
  ...
  * [PPIO Πλατφόρμα](pre-basic/providers/ppio.md)
  * [Bailian Alibaba Cloud](pre-basic/providers/a-li-yun-bai-lian.md)
...
* [Λειτουργία διαδικτύου](websearch/README.md)
  ...
  * [Σύνδεση Volcengine σε διαδίκτυο](websearch/volcengine.md)
  * [Οδηγός εγγραφής/σύνδεσης Tavily](websearch/tavily.md)
  * [Τοπική εγκατάσταση και διαμόρφωση SearXNG](websearch/searxng.md)
* [Ρυθμίσεις δεδομένων](data-settings/README.md)
  * [Αντίγραφο ασφαλείας WebDAV](data-settings/WebDAV.md)
...
* [Προσωπικές ρυθμίσεις](personalization-settings/README.md)
...
* [Πληροφορίες αναφοράς για ενσωματωμένα μοντέλα](knowledge-base/emb-models-info.md)
* [Προ-επεξεργασία εγγράφων βάσης γνώσης](knowledge-base/zhi-shi-ku-wen-dang-yu-chu-li.md)
...
* [Οδηγός χρήσης MCP](advanced-basic/mcp/README.md)
  ...
  * [Διαμόρφωση βάσης γνώσης Dify](advanced-basic/mcp/dify.md)
  * [Προσθήκη διακομιστή MCP του ModelScope](advanced-basic/mcp/tian-jia-modelscope-mcp-fu-wu-qi.md)
