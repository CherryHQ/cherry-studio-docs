...
* [Λήψη προγράμματος-πελάτη](cherrystudio/download.md)
* [Σχεδιασμός έργου](cherrystudio/planning.md)
* [Λειτουργίες](cherrystudio/preview/README.md)
  * [Διασύνδεση συνομιλίας](cherrystudio/preview/chat.md)
  ...
  * [Μικροεφαρμογές](cherrystudio/preview/app.md)
  * [Βάση γνώσεων](cherrystudio/preview/knowledge-base.md)
  * [Αρχεία](cherrystudio/preview/files.md)
  * [Βοηθός γρήγορης πρόσβασης](cherrystudio/preview/kuai-jie-zhu-shou.md)
  * [Ρυθμίσεις](cherrystudio/preview/settings/README.md)
    * [Ρυθμίσεις παρόχων μοντέλων](cherrystudio/preview/settings/providers.md)
    * [Προεπιλεγμένα μοντέλα](cherrystudio/preview/settings/default-models.md)
    * [Γενικές ρυθμίσεις](cherrystudio/preview/settings/general.md)
    * [Ρυθμίσεις οθόνης](cherrystudio/preview/settings/display.md)
    * [Ρυθμίσεις συντόμευσης πλήκτρων](cherrystudio/preview/settings/key-shortcut.md)
    * [Ρυθμίσεις δεδομένων](cherrystudio/preview/settings/data.md)
    * [Φωνητικές δυνατότητες](cherrystudio/preview/settings/yu-yin-gong-neng.md)

## Βασικά μαθήματα <a href="#pre-basic" id="pre-basic"></a>
...
* [Διαμόρφωση υπηρεσιών μοντέλου](pre-basic/providers/README.md)
  ...
  * [OneAPI και σχετικά έργα](pre-basic/providers/oneapi/README.md)
  ...
  * [Infinity AI](pre-basic/providers/wu-wen-xin-qiong.md)
...
* [Λειτουργία σύνδεσης](websearch/README.md)
  * [Δωρεάν λειτουργία σύνδεσης](websearch/mian-fei-lian-wang-mo-shi.md)
  * [Διαμόρφωση μαύρης λίστας](websearch/blacklist.md)
  * [Σύνδεση με Volcengine](websearch/volcengine.md)
  * [Οδηγός εγγραφής Tavily](websearch/tavily.md)
  * [Αυτόνομη ανάπτυξη SearXNG](websearch/searxng.md)
* [Ρυθμίσεις δεδομένων](data-settings/README.md)
  * [Οδηγός Notion](data-settings/notion.md)
  * [Οδηγός Obsidian](data-settings/obsidian.md)
  * [Οδηγός SiYuan Notes](data-settings/siyuan.md)
* [Εξατομικευμένες ρυθμίσεις](personalization-settings/README.md)
  * [Προσαρμοσμένο CSS](personalization-settings/css.md)
  * [Προτεινόμενες γραμματοσειρές](personalization-settings/font.md)
  * [Αλλαγή θέσης αποθήκευσης](personalization-settings/storage.md)
  * [Εκκαθάριση CSS](personalization-settings/clear-css.md)

## Μαθήματα βάσης γνώσεων <a href="#knowledge-base" id="knowledge-base"></a>

* [Οδηγός βάσης γνώσεων](knowledge-base/knowledge-base.md)
* [Δεδομένα βάσης γνώσεων](knowledge-base/data.md)
* [Πληροφορίες ενσωμάτωσης μοντέλων](knowledge-base/emb-models-info.md)
* [Προεπεξεργασία τεκμηρίων](knowledge-base/zhi-shi-ku-wen-dang-yu-chu-li.md)

## Προχωρημένα μαθήματα <a href="#advanced-basic" id="advanced-basic"></a>

* [Οδηγός MCP](advanced-basic/mcp/README.md)
  * [Εγκατάσταση MCP](advanced-basic/mcp/install.md)
...
* [Δομή κώδικα](contribution/code-structure.md)
* [Συνεισφορά τεκμηρίων](contribution/docs.md)

## Ερωτήσεις & Ανατροφοδότηση <a href="#question-contact" id="question-contact"></a>

* [Συχνές ερωτήσεις](question-contact/questions.md)
* [Αποτελεσματική υποβολή ερωτήσεων](question-contact/ask.md)
* [Βασικές γνώσεις](question-contact/knowledge.md)
  * [Ανατροφοδότηση και προτάσεις](question-contact/suggestions.md)

## Επικοινωνία <a href="#contact-us" id="contact-us"></a>

* [Εμπορική συνεργασία](contact-us/questions.md)
  * [Συμφωνία εμπορικής άδειας Cherry Studio](contact-us/questions/cherrystudio-xu-ke-xie-yi.md)

## Σχετικά <a href="#about" id="about"></a>
