...
Cherry Studio v1.7.0.alpha版本引入了 Agent，可以在Cherry Studio中使用Claude Code。本教程將引導您完成設置和啟動的完整流程。

### 1. 創建Anthropic類型的供應商

&#x20;任意支援Anthropic端點的服務商都可以使用，以CherryIn為例，創建一個新的 Agent 服務商，填寫好密鑰和地址，添加任意模型即可。(⚠️Agent 模式消耗token量很大，請注意token使用)
...
右鍵 Agent 可以進入編輯界面，編輯 Agent 的權限和可以使用的工具/mcp服務。
