...
* [功能介紹](cherrystudio/preview/README.md)
  ...
  * [繪圖](cherrystudio/preview/drawing.md)
  ...
  * [設置](cherrystudio/preview/settings/README.md)
    * [模型服務設置](cherrystudio/preview/settings/providers.md)
    * [預設模型設置](cherrystudio/preview/settings/default-models.md)
    * [常規設置](cherrystudio/preview/settings/general.md)
    * [顯示設置](cherrystudio/preview/settings/display.md)
    * [快捷鍵設置](cherrystudio/preview/settings/key-shortcut.md)
    * [數據設置](cherrystudio/preview/settings/data.md)
    * [語音功能](cherrystudio/preview/settings/yu-yin-gong-neng.md)

## 基礎教程 <a href="#pre-basic" id="pre-basic"></a>

* [安裝教程](pre-basic/installation/README.md)
  * [Windows](pre-basic/installation/windows.md)
  * [macOS](pre-basic/installation/macos.md)
* [模型服務配置](pre-basic/providers/README.md)
  * [阿里雲百煉](pre-basic/providers/a-li-yun-bai-lian.md)
  ...
  * [OneAPI 及其分支項目](pre-basic/providers/oneapi/README.md)
  ...
  * [自定義服務商](pre-basic/providers/zi-ding-yi-fu-wu-shang.md)
...
* [聯網模式](websearch/README.md)
  ...
  * [網絡搜索黑名單配置](websearch/blacklist.md)
  * [火山引擎接入聯網](websearch/volcengine.md)
  * [Tavily 聯網登錄註冊教學](websearch/tavily.md)
  * [SearXNG 本地部署與配置](websearch/searxng.md)
* [數據設置](data-settings/README.md)
  * [WebDAV 備份](data-settings/WebDAV.md)
  * [S3 兼容存儲備份](data-settings/s3-compatible.md)
  * [Notion 配置教學](data-settings/notion.md)
  * [Obsidian 配置教學](data-settings/obsidian.md)
  * [思源筆記配置教學](data-settings/siyuan.md)
* [個性化設置](personalization-settings/README.md)
  * [自定義 CSS](personalization-settings/css.md)
  * [字體推薦](personalization-settings/font.md)
  * [修改存儲位置](personalization-settings/storage.md)
  * [清除 CSS 設置](personalization-settings/clear-css.md)

## 知識庫教程 <a href="#knowledge-base" id="knowledge-base"></a>

* [知識庫教程](knowledge-base/knowledge-base.md)
* [知識庫數據](knowledge-base/data.md)
* [嵌入模型參考訊息](knowledge-base/emb-models-info.md)
* [知識庫文件預處理](knowledge-base/zhi-shi-ku-wen-dang-yu-chu-li.md)

## 進階教程 <a href="#advanced-basic" id="advanced-basic"></a>

* [MCP 使用教學](advanced-basic/mcp/README.md)
  * [MCP 環境安裝](advanced-basic/mcp/install.md)
...
* [程式碼結構](contribution/code-structure.md)
