...
* [功能介紹](cherrystudio/preview/README.md)
  ...
  * [智慧體](cherrystudio/preview/agents.md)
...
* [模型服務配置](pre-basic/providers/README.md)
  * [免費模型](pre-basic/providers/cherryin/README.md)
    * [智譜 GLM-4.5-Air](pre-basic/providers/cherryin/mian-fei-ti-yan-zhi-pu-glm4.5air-qing-liang-gao-xiao-xin-xuan-ze.md)
...
* [聯網模式](websearch/README.md)
  ...
  * [網路搜尋黑名單設定](websearch/blacklist.md)
  * [火山引擎接入聯網](websearch/volcengine.md)
  * [Tavily 聯網登錄註冊教程](websearch/tavily.md)
  * [SearXNG 本地部署與設定](websearch/searxng.md)
* [資料設定](data-settings/README.md)
  * [WebDAV 備份](data-settings/WebDAV.md)
  * [S3 相容儲存備份](data-settings/s3-compatible.md)
  * [Notion 設定教程](data-settings/notion.md)
  * [Obsidian 設定教程](data-settings/obsidian.md)
  * [思源筆記設定教程](data-settings/siyuan.md)
...
* [MCP 使用教程](advanced-basic/mcp/README.md)
  ...
  * [設定和使用 MCP](advanced-basic/mcp/config.md)
  * [自動安裝 MCP](advanced-basic/mcp/auto-install.md)
  * [內建 MCP 設定](advanced-basic/mcp/in-memory.md)
  * [設定 Dify 知識庫](advanced-basic/mcp/dify.md)
