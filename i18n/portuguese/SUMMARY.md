...
* [Visão Geral de Funcionalidades](cherrystudio/preview/README.md)
  ...
  * [Geração de Imagens](cherrystudio/preview/drawing.md)
  ...
  * [Configurações](cherrystudio/preview/settings/README.md)
    * [Configuração de Serviços de Modelos](cherrystudio/preview/settings/providers.md)
    * [Configuração de Modelos Padrão](cherrystudio/preview/settings/default-models.md)
    ...
    * [Configuração de Atalhos de Teclado](cherrystudio/preview/settings/key-shortcut.md)
...
* [Modo Online](websearch/README.md)
  ...
  * [Configuração de Lista Negra de Buscas](websearch/blacklist.md)
...
* [Configurações de Dados](data-settings/README.md)
  ...
  * [Tutorial de Configuração SiYuan Notes](data-settings/siyuan.md)
...
* [Referência de Modelos de Embedding](knowledge-base/emb-models-info.md)
...
* [Tutorial de Uso MCP](advanced-basic/mcp/README.md)
  ...
  * [Problemas Comuns](advanced-basic/mcp/chang-jian-wen-ti.md)
...
* [Tutorial de Uso Agent](advanced-basic/agent.md)
...
## Perguntas & Feedback <a href="#question-contact" id="question-contact"></a>

* [Perguntas Frequentes](question-contact/questions.md)
* [Como Fazer Perguntas de Forma Eficaz](question-contact/ask.md)
...
* [Informações dos Modelos](other/models-info.md)
