...
* [Funcionalidades](cherrystudio/preview/README.md)
  * [Interface de Conversação](cherrystudio/preview/chat.md)
  ...
  * [Configurações](cherrystudio/preview/settings/README.md)
    * [Configurações de Serviços de Modelos](cherrystudio/preview/settings/providers.md)
    ...
    * [Configurações de Atalhos](cherrystudio/preview/settings/key-shortcut.md)
    * [Configurações de Dados](cherrystudio/preview/settings/data.md)
    * [Funções de Voz](cherrystudio/preview/settings/yu-yin-gong-neng.md)
...
* [Configuração de Serviços de Modelos](pre-basic/providers/README.md)
  ...
  * [WenXin Qiong](pre-basic/providers/wu-wen-xin-qiong.md)
...
* [Modo Online](websearch/README.md)
  ...
  * [Configuração de Lista Negra de Pesquisa](websearch/blacklist.md)
  * [Conexão Online com VolcEngine](websearch/volcengine.md)
...
## Tutoriais da Base de Conhecimento <a href="#knowledge-base" id="knowledge-base"></a>

* [Tutorial da Base de Conhecimento](knowledge-base/knowledge-base.md)
* [Dados da Base de Conhecimento](knowledge-base/data.md)
* [Informações de Referência de Modelos de Incorporação](knowledge-base/emb-models-info.md)
* [Pré-processamento de Documentos](knowledge-base/zhi-shi-ku-wen-dang-yu-chu-li.md)
...
## Contribuição <a href="#contribution" id="contribution"></a>
...
* [Como Fazer Perguntas Eficazes](question-contact/ask.md)
* [Conhecimentos Gerais](question-contact/knowledge.md)
...
* [Cooperação Comercial](contact-us/questions.md)
  * [Acordo de Licença Comercial do Cherry Studio](contact-us/questions/cherrystudio-xu-ke-xie-yi.md)
...
* [Informações de Referência de Modelos Comuns](other/models-info.md)
