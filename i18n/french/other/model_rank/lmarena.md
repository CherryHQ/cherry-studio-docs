...
> **Date de mise à jour des données**: 2025-09-06 11:39:41 UTC / 2025-09-06 19:39:41 CST (Heure de Pékin)

{% hint style="info" %}
Cliquez sur le **nom du modèle** dans le classement pour accéder à sa page détaillée ou d'essai.
{% endhint %}

## Classement

| Classement (UB) | Classement (StyleCtrl) | Modèle                                                                                                                             | Score | Intervalle de confiance | Votes      | Fournisseur                    | Licence                    | Date de mise à jour des connaissances   |
|:---|:---|:---|:---|:---|:---|:---|:---|:---|
...
|       18 |              15 | [GLM-4.5-Air](https://z.ai/blog/glm-4.5)                                                                                        | 1393 | +9/-9   | 4,306   | Z.ai