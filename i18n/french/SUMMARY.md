...
* [Fonctionnalités](cherrystudio/preview/README.md)
  * [Interface de discussion](cherrystudio/preview/chat.md)
  ...
  * [Paramètres](cherrystudio/preview/settings/README.md)
    * [Configuration des modèles de service](cherrystudio/preview/settings/providers.md)
    * [Paramètres du modèle par défaut](cherrystudio/preview/settings/default-models.md)
    ...
    * [Raccourcis clavier](cherrystudio/preview/settings/key-shortcut.md)
    * [Paramètres des données](cherrystudio/preview/settings/data.md)
    * [Fonction vocale](cherrystudio/preview/settings/yu-yin-gong-neng.md)
...
* [Configuration des modèles](pre-basic/providers/README.md)
  ...
  * [OneAPI et projets associés](pre-basic/providers/oneapi/README.md)
...
* [Mode en ligne](websearch/README.md)
  * [Mode gratuit en ligne](websearch/mian-fei-lian-wang-mo-shi.md)
  * [Configuration de la liste noire](websearch/blacklist.md)
  * [Intégration avec VolcEngine](websearch/volcengine.md)
  * [Configuration de Tavily](websearch/tavily.md)
  * [Déploiement local de SearXNG](websearch/searxng.md)
* [Paramètres des données](data-settings/README.md)
  ...
  * [Configuration de SiYuan](data-settings/siyuan.md)
* [Personnalisation](personalization-settings/README.md)
  ...
  * [Changer l'emplacement de stockage](personalization-settings/storage.md)
  * [Effacer les paramètres CSS](personalization-settings/clear-css.md)

## Base de connaissances <a href="#knowledge-base" id="knowledge-base"></a>
...
* [Modèles d'encodage](knowledge-base/emb-models-info.md)
* [Prétraitement des documents](knowledge-base/zhi-shi-ku-wen-dang-yu-chu-li.md)

## Tutoriels avancés <a href="#advanced-basic" id="advanced-basic"></a>

* [Utilisation de MCP](advanced-basic/mcp/README.md)
  * [Installation de MCP](advanced-basic/mcp/install.md)
  * [Configuration de MCP](advanced-basic/mcp/config.md)
  * [Installation automatique](advanced-basic/mcp/auto-install.md)
  * [Configuration mémoire](advanced-basic/mcp/in-memory.md)
  * [Base de connaissances Dify](advanced-basic/mcp/dify.md)
...
## Assistance <a href="#question-contact" id="question-contact"></a>

* [FAQ](question-contact/questions.md)
* [Comment poser des questions](question-contact/ask.md)
* [Connaissances générales](question-contact/knowledge.md)
...
* [Coopération commerciale](contact-us/questions.md)
  * [Licence commerciale de Cherry Studio](contact-us/questions/cherrystudio-xu-ke-xie-yi.md)
...
* [Référence des modèles](other/models-info.md)
