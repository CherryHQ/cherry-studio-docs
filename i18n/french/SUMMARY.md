...
* [Présentation des fonctionnalités](cherrystudio/preview/README.md)
  ...
  * [Création artistique](cherrystudio/preview/drawing.md)
  ...
  * [Assistants rapides](cherrystudio/preview/kuai-jie-zhu-shou.md)
...
* [Configuration des services de modèles](pre-basic/providers/README.md)
  ...
  * [ModelScope (Mada)](pre-basic/providers/modelscope.md)
...
* [Mode connecté](websearch/README.md)
  ...
  * [Intégration Volc Engine en mode connecté](websearch/volcengine.md)
  * [Guide d'inscription et de connexion Tavily](websearch/tavily.md)
  * [Déploiement et configuration locale SearXNG](websearch/searxng.md)
* [Paramètres des données](data-settings/README.md)
  ...
  * [Configuration des abonnements aux assistants](data-settings/assistants-subscribe.md)
...
## Tutoriels Base de connaissances <a href="#knowledge-base" id="knowledge-base"></a>

* [Tutoriel Base de connaissances](knowledge-base/knowledge-base.md)
...
* [Contribution au code](contribution/code.md)
* [Contribution à la documentation](contribution/docs.md)

## Questions & Retours <a href="#question-contact" id="question-contact"></a>

* [FAQ](question-contact/questions.md)
* [Comment poser des questions efficacement](question-contact/ask.md)
* [Articles pédagogiques](question-contact/knowledge.md)
...
* [Partenariats commerciaux](contact-us/questions.md)
  * [Accord de licence open source Cherry Studio](contact-us/questions/cherrystudio-xu-ke-xie-yi.md)
