...
La version v1.7.0.alpha de Cherry Studio introduit les Agents, permettant d'utiliser Agent dans Cherry Studio. Ce tutoriel vous guidera à travers le processus complet de configuration et de lancement.
