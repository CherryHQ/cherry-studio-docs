...
* [機能紹介](cherrystudio/preview/README.md)
  ...
  * [設定](cherrystudio/preview/settings/README.md)
    ...
    * [ローカルモデル](cherrystudio/preview/settings/local-models.md)
    * [一般設定](cherrystudio/preview/settings/general.md)
    * [外観設定](cherrystudio/preview/settings/display.md)
    * [ショートカットキー設定](cherrystudio/preview/settings/key-shortcut.md)
    * [データ設定](cherrystudio/preview/settings/data.md)
    * [音声機能](cherrystudio/preview/settings/yu-yin-gong-neng.md)

## 基礎チュートリアル <a href="#pre-basic" id="pre-basic"></a>

* [インストールチュートリアル](pre-basic/installation/README.md)
  * [Windows](pre-basic/installation/windows.md)
  * [macOS](pre-basic/installation/macos.md)
* [モデルサービス設定](pre-basic/providers/README.md)
  * [無料モデル](pre-basic/providers/cherryin/README.md)
  ...
  * [カスタムサービスプロバイダー](pre-basic/providers/zi-ding-yi-fu-wu-shang.md)
  * [CherryIN](pre-basic/providers/cherryin-1.md)

***

* [インターネットモード](websearch/README.md)
  * [無料インターネットモード](websearch/mian-fei-lian-wang-mo-shi.md)
  * [ネットワーク検索ブラックリスト設定](websearch/blacklist.md)
  * [火山エンジンを用いたインターネット接続](websearch/volcengine.md)
  * [Tavily インターネット接続ログイン登録チュートリアル](websearch/tavily.md)
  * [SearXNG ローカルデプロイと設定](websearch/searxng.md)
* [データ設定](data-settings/README.md)
  * [WebDAV バックアップ](data-settings/WebDAV.md)
  * [S3 互換ストレージバックアップ](data-settings/s3-compatible.md)
  * [Notion の設定とエクスポート](data-settings/notion.md)
  * [Obsidian 設定チュートリアル](data-settings/obsidian.md)
  * [SiYuan の設定とエクスポート](data-settings/siyuan.md)
...
* [カスタマイズ設定](personalization-settings/README.md)
  ...
  * [ストレージ位置の変更](personalization-settings/storage.md)
  * [CSS 設定のクリア](personalization-settings/clear-css.md)
...
* [ナレッジベース文書の前処理](knowledge-base/zhi-shi-ku-wen-dang-yu-chu-li.md)

## 進階チュートリアル <a href="#advanced-basic" id="advanced-basic"></a>

* [MCP 使用チュートリアル](advanced-basic/mcp/README.md)
  * [MCP 環境インストール](advanced-basic/mcp/install.md)
  * [MCP の設定と使用](advanced-basic/mcp/config.md)
  * [MCP の自動インストール](advanced-basic/mcp/auto-install.md)
  * [組み込み MCP 設定](advanced-basic/mcp/in-memory.md)
  * [Dify ナレッジベースの設定](advanced-basic/mcp/dify.md)
...
* [API サーバー](advanced-basic/api-server.md)
...
* [コードのコントリビュート](contribution/code.md)
* [ドキュメントのコントリビュート](contribution/docs.md)

## 問題＆フィードバック <a href="#question-contact" id="question-contact"></a>

* [よくある質問](question-contact/questions.md)
* [効果的な質問の方法](question-contact/ask.md)
* [知識の解説](question-contact/knowledge.md)
* [フィードバック＆提案](question-contact/suggestions.md)

## お問い合わせ <a href="#contact-us" id="contact-us"></a>

* [ビジネスコラボレーション](contact-us/questions.md)
  * [Cherry Studio オープンソースライセンス契約](contact-us/questions/cherrystudio-xu-ke-xie-yi.md)
