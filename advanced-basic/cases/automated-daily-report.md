...
<figure><img src="../../.gitbook/assets/cherry-v2-guide-case-daily-report-schedule.png" alt="设置中已经保存并启用的每日项目进展简报定时任务和完整提示词"><figcaption><p>① 任务已经启用并显示下次运行时间；② 提示词明确四段结构、缺失数据处理和频道发送条件。</p></figcaption></figure>
