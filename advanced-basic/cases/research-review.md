...
<figure><img src="../../.gitbook/assets/cherry-v2-guide-case-research-review.png" alt="对发布方案提出统一检查要求后，Cherry Assistant 按安全、稳定性、监控、回滚、通知和验收给出实际评审结果"><figcaption><p>① 提问中写清检查维度和已知条件；② 结果按同一结构展开，方便继续比较、追问和人工核对。</p></figcaption></figure>
