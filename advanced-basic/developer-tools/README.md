...
<table data-view="cards"><thead><tr><th></th><th></th><th data-hidden data-card-target data-type="content-ref"></th></tr></thead><tbody><tr><td><strong>编码搭档（Code CLI）</strong></td><td>管理安装来源、模型连接和启动目录</td><td><a href="code-cli.md">code-cli.md</a></td></tr><tr><td><strong>API 网关</strong></td><td>理解 Agent 依赖与本机 API 调用</td><td><a href="api-gateway.md">api-gateway.md</a></td></tr><tr><td><strong>调用链与开发者模式</strong></td><td>复现并定位一次具体请求</td><td><a href="trace.md">trace.md</a></td></tr></tbody></table>
