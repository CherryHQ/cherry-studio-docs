...
**API 密钥**形如 `cs-sk-xxxxxxxx-xxxx-xxxx-xxxx-xxxxxxxxxxxx`，在首次启用 API 服务器时自动生成并**持续保留**，重启服务器不会刷新。如需手动换新，点击右侧 **重新生成** 按钮，旧密钥立即失效。
...
* **停止**：点击红色 ⏹ 图标，会立即关闭服务；正在使用 [Cherry Agent](agent.md) 与 [频道](agent-channels.md) 的连接会同步中断
