...
<figure><img src="../../.gitbook/assets/clipboard (24).png" alt="Agent 从说明交付物、选择工作目录到检查文件和结果的任务闭环图"><figcaption><p>工作目录、权限和完成标准贯穿整个任务；需要修改时回到计划阶段重新确认。</p></figcaption></figure>
