...
V2 的主窗口由侧边栏、标签页和内容区组成。对话话题与 Agent 任务可以同时开在多个标签页，也可以拆成独立窗口；输入区工具栏则可以按使用习惯调整。
...
<table data-view="cards"><thead><tr><th></th><th></th></tr></thead><tbody><tr><td>多窗口与标签页</td><td>拆分、置顶和重新接回窗口</td></tr><tr><td>输入工具栏与效率工具</td><td>提示词管理、快捷键、快捷助手和划词助手</td></tr></tbody></table>
