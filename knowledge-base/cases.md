...
<figure><img src="../.gitbook/assets/clipboard (49).png" alt="由多条制度资料组成并全部就绪的员工差旅制度知识库"><figcaption><p>制度条款和 FAQ 分开维护，更新其中一份时不必重做全部资料。</p></figcaption></figure>
...
<figure><img src="../.gitbook/assets/clipboard (29).png" alt="资料来源经过知识库召回和 Agent 整理后形成文字文件或多语言图片的内容工作流图"><figcaption><p>先保留证据和限制，再让 Agent 整理为报告；不要让成品反过来掩盖原始来源。</p></figcaption></figure>
