...
<figure><img src="../../.gitbook/assets/v2/websearch-chat-toggle.png" alt=""><figcaption><p>对话输入栏的地球图标：点击即对当前对话开启联网（提示会显示当前搜索服务商）</p></figcaption></figure>
...
已知支持原生联网的模型 / 服务商（示例，具体以客户端显示为准）：Google Gemini（部分版本）、OpenRouter、智谱 AI、阿里云百炼（部分模型）、xAI Grok 等。
...
<figure><img src="../../.gitbook/assets/v2/websearch-settings-layout.png" alt=""><figcaption><p>网络搜索设置：搜索服务商 / URL 获取服务商 两个分区，与底部「优先使用已配置的搜索服务」开关</p></figcaption></figure>
...
<figure><img src="../../.gitbook/assets/v2/websearch-advanced-settings.png" alt=""><figcaption><p>高级设置：搜索结果个数、压缩方法（不压缩 / 截断）、黑名单</p></figcaption></figure>
