...
配置入口位于 **设置 > 数据 > 思源笔记配置**。**设置 > 数据 > 导出菜单设置**只控制“导出到思源笔记”是否显示。
...
![思源笔记配置页面的 API 地址、令牌、笔记本 ID 和根路径](../../.gitbook/assets/cherry-v2-071-siyuan-zh-cn.png)
...
进入 **设置 > 数据 > 导出菜单设置**，打开 **导出到思源笔记**。若已开启，重新进入当前对话再打开菜单。
