...
| 功能                                            | 文档                          |
| --------------------------------------------- | --------------------------- |
| [API 服务器](/broken/pages/VURFIGIavkyQJk3B3H2v) | 暴露本地 OpenAI 兼容 API          |
| [全局记忆](/broken/pages/vLGRwSy6YvFqXFxoqvsN)    | 跨会话记忆系统                     |
| [技能](/broken/pages/tgdekmdz04XIhvqtGjIa)      | 为助手或智能体加装专项能力               |
| [快捷短语](/broken/pages/uMnxI9WpZielUdbcA5zU)    | 管理可复用提示词模板                  |
| [频道](/broken/pages/UbNiAoRqD0PpkxJGCUEn)      | Agent 接入飞书/Telegram 等       |
| [定时任务](/broken/pages/CEjy3AjDD84FmqCpupam)    | Agent 按 Cron 定时运行           |
| [MCP 服务器](/broken/pages/xypQ48eulwEGImLNttzF) | Model Context Protocol 工具接入 |
